...
summary: >-
  业务安全合规检测通过 CI/CD
  阶段的卡点，对新增代码进行分析、合规管控和溯源，对构建产物进行发版管控，以避免隐私和合规问题影响线上产品，从而带来安全合规风险。


  为了解决 CI 中间产物检测无法覆盖源码、检出问题定位成本高等问题，引入了 CI 增量源码检测，可以覆盖 Android/iOS
  双端源码检测，并实现检出问题的自动精准定位和问题聚合。


  在 CD 产物检测中，通过 BDAnalysis 引擎生成了调用链，弥补了可能存在的漏放风险，并通过 dex 扫描替代 smali 扫描，将 CD
  产物检测的平均耗时从 175 秒降低至 32 秒，大大提升了检测工具的精度和速度。
---
